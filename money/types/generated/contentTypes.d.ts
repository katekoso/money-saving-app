...
export interface ApiTargetTarget extends Schema.CollectionType {
  ...
  attributes: {
    title: Attribute.String & Attribute.Required;
    sum: Attribute.Integer & Attribute.Required;
    image: Attribute.Media;
    priority: Attribute.Enumeration<['min', 'med', 'max']> &
      Attribute.Required &
      Attribute.DefaultTo<'med'>;
    priorityTime: Attribute.Enumeration<['short', 'long']> &
      Attribute.Required &
      Attribute.DefaultTo<'short'>;
    start: Attribute.Date;
    finish: Attribute.Date;
    currentSum: Attribute.Integer & Attribute.DefaultTo<0>;
    user: Attribute.Relation<
      'api::target.target',
      'oneToOne',
      'plugin::users-permissions.user'
